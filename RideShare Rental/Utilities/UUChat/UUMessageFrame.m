...
- (void)setMessage:(UUMessage *)message{
    ...
    if (_message.from == UUMessageFromMe) {
        ...
        if(_message.attachement.length == 0)
        {
            _contentF = CGRectMake(contentX-30, contentY, contentSize.width + ChatContentLeft + ChatContentRight, contentSize.height + ChatContentTop + ChatContentBottom+_ContentSize);
            
        }
        else
        {
            _contentF = CGRectMake(contentX-30, contentY, contentSize.width + ChatContentLeft + ChatContentRight, contentSize.height + ChatContentTop + ChatContentBottom+_ContentSize+20);
