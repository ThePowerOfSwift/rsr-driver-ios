...
open class WWCalendarTimeSelector: UIViewController, UITableViewDelegate, UITableViewDataSource, WWCalendarRowProtocol, WWClockProtocol {
    ...
    open var optionCalendarBackgroundColorTodayHighlight = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionCalendarBackgroundColorPastDatesHighlight = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionCalendarBackgroundColorFutureDatesHighlight = Themes.sharedInstance.returnThemeColor()
    open var optionCalendarBackgroundColorFutureDatesFlash = UIColor.white
    
    open var startingDate: Date = Date()
    open var EndingDate: Date = Date()
    ...
    open var optionClockBackgroundColorAMPMHighlight = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionClockBackgroundColorHourHighlight = Themes.sharedInstance.returnThemeColor()
    open var optionClockBackgroundColorHourHighlightNeedle = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionClockBackgroundColorMinuteHighlight = Themes.sharedInstance.returnThemeColor()
    open var optionClockBackgroundColorMinuteHighlightNeedle = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionButtonFontColorCancel = Themes.sharedInstance.returnThemeColor()
    open var optionButtonFontColorDone = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionTopPanelBackgroundColor = Themes.sharedInstance.returnThemeColor()
    ...
    open var optionSelectorPanelBackgroundColor = Themes.sharedInstance.returnThemeColor()
    ...
    open func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == calendarTable {
            if let c = tableView.dequeueReusableCell(withIdentifier: "cell") {
                ...
                calRow.Startingdate = startingDate
                calRow.endingdate = EndingDate
...
internal class WWCalendarRow: UIView {
    ...
    internal var Startingdate: Date!
    internal var endingdate: Date!
        ...
        if detail.type == .month {
            ...
            for i in 1...7 {
                if date.weekday == i {
                    ...
                    if(date.isBetween(Startingdate, and: endingdate))
                    {
                        fontColor = dateFutureFontColor
...
extension Date {
    func isBetween(_ date1: Date, and date2: Date) -> Bool {
        ...
        if(Calendar.current.isDate(date1, inSameDayAs:self)
            || Calendar.current.isDate(date2, inSameDayAs:self))
        {
            return true
        }
