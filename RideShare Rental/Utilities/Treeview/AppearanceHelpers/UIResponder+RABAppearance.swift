...
extension AppDelegate {
    ...
    func applyDefaultAppearance() {
        ...
        let attributes: [NSAttributedStringKey : Any] = [
            NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue) : UIFont.appNavBarTitleFont(),
            NSAttributedStringKey.foregroundColor : UIColor.appNavigationBarForgroundColor()
        ]
        ...
        UIBarButtonItem.appearance().setTitleTextAttributes([
            ...
            NSAttributedStringKey.font : UIFont.appLightFontWithSize(18.0)
            ]
            , for: UIControlState())
        ...
        UIBarButtonItem.appearance().setTitleTextAttributes([
            NSAttributedStringKey.foregroundColor : UIColor.white,
            NSAttributedStringKey.font : UIFont.appLightFontWithSize(18)
            ]
            , for: UIControlState())
...
//        UIButton.appearance().backgroundColor = UIColor.appPrimaryColor()
        ...
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedStringKey.font: UIFont.appRegularFontWithSize(10.0), NSAttributedStringKey.foregroundColor: UIColor.appPrimaryColor()], for: .selected)
        // Properties when tabbar is unselected
        UITabBarItem.appearance().setTitleTextAttributes([NSAttributedStringKey.font: UIFont.appRegularFontWithSize(10.0), NSAttributedStringKey.foregroundColor: UIColor.appTabBarForgroundColor()], for: UIControlState())
        ...
        if #available(iOS 9.0, *) {
            ...
            UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).defaultTextAttributes = [NSAttributedStringKey.foregroundColor.rawValue: UIColor.white, NSAttributedStringKey.font.rawValue: UIFont.systemFont(ofSize: 14.0)]
            ...
            UITextField.appearance(whenContainedInInstancesOf: [UISearchBar.self]).defaultTextAttributes = [NSAttributedStringKey.foregroundColor.rawValue: UIColor.black, NSAttributedStringKey.font.rawValue: UIFont.systemFont(ofSize: 14.0)]
            UIBarButtonItem.appearance(whenContainedInInstancesOf: [UISearchBar.self]).setTitleTextAttributes([
                NSAttributedStringKey.foregroundColor : UIColor(red: 0.259, green: 0.259, blue: 0.259, alpha: 1.00)
                ]
                , for: UIControlState())
